...
const About: React.FC = () => {
  ...
  const structuredData = {
    ...
    "@type": "AboutPage",
    "name": "About Track US Visa",
    "description": "Learn about our mission to empower immigrants with AI-driven visa bulletin analysis and forecasting. Built with modern technology for accurate predictions.",
    "url": "https://trackusvisa.com/about",
    "mainEntity": {
      "@type": "Organization",
      "name": "Track US Visa",
      "description": "Empowering immigrants with AI-driven visa bulletin analysis and forecasting",
    ...
    "breadcrumb": {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "About",
          "item": "https://trackusvisa.com/about"
        }
      ]
    }
  };
  ...
  return (
    <>
      <SEO 
        title="About Us | Track US Visa - AI-Powered Immigration Analysis"
        description="Learn about our mission to empower immigrants with AI-driven visa bulletin analysis and forecasting. Built with modern technology for accurate predictions and real-time updates."
        keywords="about track us visa, immigration analysis, AI forecasting, visa bulletin technology, immigration platform, priority date analysis"
        canonical="/about"
