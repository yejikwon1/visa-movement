...
import { predictFilingDateFromModel } from './predictFilingDate';
import forecastData from './eb3_forecast.json';
=======
...
>>>>>>> 1479a3143f7f2dd8dc2901b03cf3c275c4a3560d
...
<<<<<<< HEAD
  ...
  const [predictedFilingDate, setPredictedFilingDate] = useState<string | null>(null);
=======
>>>>>>> 1479a3143f7f2dd8dc2901b03cf3c275c4a3560d
...
<<<<<<< HEAD
  ...
  const checkStatus = () => {
    ...
    if (filingCutoffRaw) {
      ...
      const predicted = predictFilingDateFromModel(pdString);
      setPredictedFilingDate(predicted);
    } else {
      setFilingDateResult('N/A');
      setPredictedFilingDate(null);
    }
...
<<<<<<< HEAD
      ...
      {(finalActionResult || filingDateResult || expectedPermDate || predictedFilingDate) && (
        <Card sx={{ mb: 2 }}>
          <CardContent>
            ...
            {expectedPermDate && (
              <Typography>Expected PERM Processing Date: 📅 {expectedPermDate}</Typography>
            )}
            {predictedFilingDate && (
              <Typography>📆 Expected Filing Date: {predictedFilingDate}</Typography>
            )}
          </CardContent>
        </Card>
=======
